...
global select_all_query, insert_query, curr_dir
...
def user_data_update():
    EXTERNAL_DATABASE = "postgres://ysnnfooijfyqpq:2255172969ba42378ca61ed80e5a001c4166d40005544e66ceea5350efeb401c@ec2-174-129-240-67.compute-1.amazonaws.com:5432/d75eoc3l0g0qpu"
    ...
    for row in rows:
        ...
        try:
            ...
            pass
    info("not user specific","user data fetch and store",dt.datetime.now())
